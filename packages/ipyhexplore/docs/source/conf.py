...
# -*- coding: utf-8 -*-
#
# ipyhexplore documentation build configuration file
#
...
project = 'ipyhexplore'
copyright = '2020, Adrian Vogelsgesang'
...
_version_py = os.path.join(repo, 'ipyhexplore', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipyhexploredoc'
...
latex_documents = [
    (master_doc, 'ipyhexplore.tex', 'ipyhexplore Documentation',
     'Adrian Vogelsgesang', 'manual'),
]
