...
(function(root, factory) {
    ...
    */
    const KaitaiStream = function(arrayBuffer, byteOffset) {
   ...
   */
    KaitaiStream.prototype.readS2le = function(e) {
        this.ensureBytesLeft(2);
        const v = this._dataView.getInt16(this.pos, 1);
        this.pos += 2;
        return v;
    };
   ...
   */
    KaitaiStream.prototype.readS4le = function(e) {
        this.ensureBytesLeft(4);
        const v = this._dataView.getInt32(this.pos, 1);
        this.pos += 4;
        return v;
    };
   ...
   */
    KaitaiStream.prototype.readU2le = function(e) {
        this.ensureBytesLeft(2);
        const v = this._dataView.getUint16(this.pos, 1);
        this.pos += 2;
        return v;
    };
   ...
   */
    KaitaiStream.prototype.readU4le = function(e) {
        this.ensureBytesLeft(4);
        const v = this._dataView.getUint32(this.pos, 1);
        this.pos += 4;
        return v;
    };
   ...
   */
    ...
    KaitaiStream.prototype.readF4le = function(e) {
        this.ensureBytesLeft(4);
        const v = this._dataView.getFloat32(this.pos, 1);
        this.pos += 4;
        return v;
    };
    ...
    KaitaiStream.prototype.readF8le = function(e) {
        this.ensureBytesLeft(8);
        const v = this._dataView.getFloat64(this.pos, 1);
        this.pos += 8;
        return v;
    };
    ...
    KaitaiStream.prototype.readBitsInt = function(n) {
        ...
        if (n > 32) throw new Error(`readBitsInt: the maximum supported bit length is 32 (tried to read ${n} bits)`);
        ...
        const res = (this.bits & mask) >>> shiftBits;
   ...
   */
    ...
    KaitaiStream.processRotateLeft = function(data, amount, groupSize) {
        if (groupSize != 1) throw "unable to rotate group of " + groupSize + " bytes yet";

        const mask = groupSize * 8 - 1;
        const antiAmount = -amount & mask;

        const r = new Uint8Array(data.length);
        for (let i = 0; i < data.length; i++) r[i] = ((data[i] << amount) & 0xff) | (data[i] >> antiAmount);
    ...
    KaitaiStream.processZlib = function(buf) {
        if (typeof require !== "undefined") {
            ...
            if (typeof KaitaiStream.zlib === "undefined") KaitaiStream.zlib = require("zlib");
            ...
            // we'll throw.
            if (typeof KaitaiStream.zlib === "undefined" && typeof KaitaiStream.depUrls.zlib !== "undefined") {
    ...
    const EOFError = (KaitaiStream.EOFError = function(bytesReq, bytesAvail) {
        this.name = "EOFError";
    ...
    const UndecidedEndiannessError = (KaitaiStream.UndecidedEndiannessError = function() {
    ...
    const ValidationNotEqualError = (KaitaiStream.ValidationNotEqualError = function(expected, actual) {
    ...
    const ValidationLessThanError = (KaitaiStream.ValidationLessThanError = function(min, actual) {
    ...
    const ValidationGreaterThanError = (KaitaiStream.ValidationGreaterThanError = function(max, actual) {
    ...
    const ValidationNotAnyOfError = (KaitaiStream.ValidationNotAnyOfError = function(actual, io, srcPath) {
  ...
  **/
    KaitaiStream.createStringFromArray = function(array) {
        ...
        const chunks = [];
        const useSubarray = typeof array.subarray === "function";
        for (let i = 0; i < array.length; i += chunk_size) {
            chunks.push(
                String.fromCharCode.apply(
                    null,
                    useSubarray ? array.subarray(i, i + chunk_size) : array.slice(i, i + chunk_size),
                ),
            );
        }
        return chunks.join("");
